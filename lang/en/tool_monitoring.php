...
$string['quiz_attempts_in_progress_max_deadline_seconds'] = 'Maximum deadline time (seconds)';
$string['quiz_attempts_in_progress_max_idle_seconds'] = 'Maximum idle time (seconds)';
