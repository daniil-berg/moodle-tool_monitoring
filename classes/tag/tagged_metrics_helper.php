...
/**
 * Helper class for the callback used by the tag area tool_monitoring/metrics to search for metrics
 * tagged with a specific tag.
 */
class tagged_metrics_helper {
    /**
     * Returns metrics tagged with a specified tag.
     *
     * This is a callback used by the tag area tool_monitoring/metrics to search for metrics
     * tagged with a specific tag.
     *
     ...
     */
    static function get_tagged_metrics($tag, $exclusivemode = false, $fromctx = 0, $ctx = 0, $rec = true, $page = 0) {
        global $OUTPUT;
        ...
        if ($items) {
            ...
            return new tagindex($tag, 'tool_monitoring', 'metrics', $content,
