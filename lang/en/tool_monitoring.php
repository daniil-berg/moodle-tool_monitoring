...
$string['error:events_config:eventnames_invalid'] = 'Invalid event class name(s) provided: {$a}';
$string['error:events_config:timewindows_invalid'] = 'Invalid time window(s) provided: {$a}';
...
$string['events_description'] = 'Number of selected events in the standard log store';
$string['events_event_names'] = 'Events';
$string['events_event_names_help'] = 'Select event classes to count. If none are selected, this metric will not export any values.';
$string['events_time_windows'] = 'Time window (seconds)';
$string['events_time_windows_help'] = 'Maximum age of log entries to count, in seconds. Add one or more values; the metric will produce a separate metric value for each time window.';
