...
2. Define the metric class.
   1. Same as above, implement the abstract `metric` methods.
   2. Use the [`with_config`][. with_config] trait and implement the `get_default_config` method by returning an instance of your config class from step 1.
