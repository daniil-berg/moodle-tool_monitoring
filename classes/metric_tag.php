...
class metric_tag extends core_tag_tag implements cacheable_object_interface {
    ...
    public const ITEM_TYPE = 'metrics';
     ...
     *
     * @param registered_metric $metric Metric to set tags for.
     * @param string ...$tagnames Names of tags to set.
     * @throws coding_exception
     * @throws dml_exception
     */
    public static function set_for_metric(registered_metric $metric, string ...$tagnames): void {
