 ...
 * added convenience and type safety.
 *
 * @package    tool_monitoring
 * @copyright  2025 MootDACH DevCamp
 *             Daniel Fainberg <d.fainberg@tu-berlin.de>
...
final class metrics_cache {
     ...
     * @return registered_metric|false Metric with the specified qualified name, or `false` if it is not found in the cache.
     * @throws coding_exception
     */
    public static function get(string $qualifiedname): registered_metric|false {
     ...
     * @return array<string, registered_metric|false> Associative array of `$qualifiednames` mapped to {@see registered_metric}
     *                                                instances or `false` if no matching metric was found in the cache.
     * @throws coding_exception
     */
