...
$functions = [
    'tool_monitoring_set_metric_enabled' => [
        'classname' => 'tool_monitoring\external\set_metric_enabled',
        'description' => 'Enable or disable a monitoring metric.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'tool/monitoring:manage_metrics',
    ],
];
