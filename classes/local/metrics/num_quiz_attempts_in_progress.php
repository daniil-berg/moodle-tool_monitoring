 ...
 * Implements the num_quiz_attempts_in_progress metric.
 */
class num_quiz_attempts_in_progress extends simple_metric {
    ...
    public function calculate(int|null $max_seconds_ago = null, int|null $max_seconds_to_end = null): void {
        global $DB;
        $now = time();
        $where = 'state = :state';
        ...
        $this->value = $DB->count_records_select('quiz_attempts', $where, $params);
    }
}